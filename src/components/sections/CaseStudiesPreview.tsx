...
const CaseStudiesPreview: React.FC = () => {
  const { data: caseStudies, loading } = useCollection<CaseStudy>("caseStudies");
  ...
  return (
    <section className={styles.section} id="case-studies-preview" ref={sectionRef}>
      ...
      <div className={styles.sectionWrap}>
        <div className={styles.headerBlock}>
          ...
          <div className={styles.sectionSub}>
            Real problems, real solutions — a closer look at my most impactful work.
          </div>
        </div>
          ...
          {loading
            ...
            : caseStudies.map((study, i) => (
                <motion.article
                  ...
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => e.key === "Enter" && handleCardClick(study.id)}
                    ...
                    <div className={styles.cardImagePlaceholder}>
                      <svg viewBox="0 0 48 48" fill="none" width="48" height="48">
                        ...
                        <path
                          ...
                          opacity="0.6"
                        />
                        <circle cx="18" cy="18" r="4" fill="#3d9e6a" opacity="0.4" />
                      </svg>
                    </div>
                  )}
