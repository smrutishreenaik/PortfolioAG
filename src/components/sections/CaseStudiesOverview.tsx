        ...
        {loading ? (
          ...
          >
            ...
            <div className={styles.carouselTrack}>
              <AnimatePresence mode="wait" custom={direction}>
                <motion.div
                  ...
                  custom={direction}
                  variants={{
                    enter: (d: number) => ({ x: d > 0 ? 72 : -72, opacity: 0, scale: 0.97 }),
                    center: { x: 0, opacity: 1, scale: 1 },
                    exit: (d: number) => ({ x: d > 0 ? -72 : 72, opacity: 0, scale: 0.97 }),
                  }}
                  initial="enter"
                  animate="center"
                  exit="exit"
                ...
                >
                  ...
                  {current.recommendedDate && (
                    <p className={styles.recommendedDate}>{current.recommendedDate}</p>
                  )}
                </motion.div>
              </AnimatePresence>
            </div>
            ...
            <div className={styles.controls}>
              <button className={styles.navBtn} onClick={goPrev} aria-label="Previous testimonial" disabled={testimonials.length <= 1}>
                <ChevronLeft />
              </button>
              ...
              <button className={styles.navBtn} onClick={goNext} aria-label="Next testimonial" disabled={testimonials.length <= 1}>
                <ChevronRight />
              </button>
            </div>
