...
- [ ] **Manage Projects (CRUD):**
    ...
    - Image upload integration with Firebase Storage to attach screenshots to projects.
...
- [ ] **Manage Testimonials (CRUD):**
    ...
    - Form to add a new testimonial (person name, link to linkedin page, profile pic, their position, company, date when they recommended me).
- [ ] Make sure to add forms to upload real pictures and not url links. 
- [ ] Raise an error if image size is bigger than standard size
